    ...
    <div className="relative bg-[#092241] h-[50vh] lg:h-[100vh] z-0 overflow-hidden">
      ...
      <div className="fix12 pt-[125px] z-10 md:pt-[140px] xl-1920:pt-44">
        ...
        <h1
          ...
          // transition={{ duration: 1, ease: [0.7, 0, 0.4, 1] }}
          // viewport={{ amount: 0.1, once: true }}
          className="md:text-[60px] text-[30px] max-w-fit md:w-[400px] w-fit ftp-500 text-white border-b-[8px] border-[#F7E327] whitespace-nowrap overflow-hidden"
        >
          Sustainability
        </h1>
      </div>
...
//           transition={{ duration: 1, ease: [0.7, 0, 0.4, 1] }}
//           viewport={{ amount: 0.1, once: true }}
//           className="text-[60px] max-w-fit ftp-500 text-white border-b-[8px] border-[#F7E327] whitespace-nowrap overflow-hidden"
//         >
//           About Us &nbsp;&nbsp;&nbsp;
//         </motion.h1>
//       </div>
