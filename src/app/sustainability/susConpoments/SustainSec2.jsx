          ...
          <div className="flex-1  xl:w-[538px] xl:min-h-[540px] ">
            <div className="w-fit">
              <motion.h1
                ...
                className="text-[#141414] md:text-[44px] sm:text-[32px] text-[24px] fpt-600 md:leading-[48.84px] leading-[110%] pb-3"
              >
...
//                 transition={{ duration: 1.4, ease: [0.7, 0, 0.4, 1] }}
//                 viewport={{ amount: 0.1, once: true }}
//                 className="text-[#141414] md:text-[44px] sm:text-[32px] text-[24px] fpt-600 md:leading-[48.84px] leading-[110%] pb-3 whitespace-nowrap"
//               >
//                 Inspiring Green
//                 <br /> Development
//               </motion.h1>
