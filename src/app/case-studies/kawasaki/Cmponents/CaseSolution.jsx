const CaseSolution = () => {
  return (
    ...
    >
      ...
      <p className="fsans-400 text-[16px] text-[#fff] lg:w-[975px] lg:text-center">
      ...
      <div className="relative">
        ...
        <div className="space-y-8">
          <div className="text-white flex items-start lg:w-[975px]  caseSolGlass border-[1px] border-white justify-start sm:justify-center gap-5 p-7">
            <img className="mt-2" src="/caseInside/caseSolshape.svg" alt="" />
