...
//               // transition={{ duration: 1, ease: [0.7, 0, 0.4, 1] }}
//               // viewport={{ amount: 0.1, once: true }}
//               className="md:text-[60px]  text-[24px] md:w-[400px] w-fit fpt-500 text-white border-b-[8px] border-[#F7E327] whitespace-nowrap overflow-hidden max-w-fit"
//             >
//               Hindalco
//             </h1>
//           </div>
...
const CasINSpot = () => {
  const [isActive, setIsActive] = useState(1);
  return (
    <div className="bg-[#fff] bg-cover bg-center pt-[50px] overflow-hidden">
      <div className="fix12 pt-20 pb-[60px] overflow-hidden">
        <div className="pb-16">
          <p className="text-[#00000040] text-base fsans-400 pb-7">
            <Link
              href="/"
              className="hover:text-black transition-colors duration-300 text-[13px] sm:text-base max-w-fit"
            >
              Home
            </Link>{" "}
            &gt;{" "}
        ...
        <div className="imgCon">
          <img src="/caseInside/hindspot.png" alt="" />
        </div>
      </div>
    </div>
  );
