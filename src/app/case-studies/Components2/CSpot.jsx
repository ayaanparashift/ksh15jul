...
const CSpot = () => {
  return (
    <div className="relative bg-[#fff] bg-cover bg-no-repeat z-0 overflow-hidden">
      {/* <div className=""> */}
      <div className="fix12 pt-[140px] ">
        ...
        <h1
          initial={{ width: 0 }}
          className="text-[28px] sm:text-[32px] md:text-[60px] max-w-fit whitespace-nowrap overflow-hidden fpt-500 text-black border-b-[8px] border-[#F7E327] "
        >
          Case Studies
        </h1>
      </div>
