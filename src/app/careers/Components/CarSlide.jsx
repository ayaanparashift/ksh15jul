...
import "swiper/css/navigation";
import "swiper/css/thumbs";
import "swiper/css/effect-fade"; // ✅ Required for fade animation
import CareerSlideCard from "./CareerSlideCard";
...
export const CarSlide = () => {
  ...
  return (
    <div className="w-full pt-[5%] lg:pt-[70px] overflow-visible">
      ...
      <div className="w-full lg:bg-[linear-gradient(to_bottom,#ffffff_90%,#092241_10%)]">
        <div className="fix12 !overflow-visible">
          <h1 className="md:text-[44px] text-[24px] text-[#092241] leading-[111%] w-full pb-[10px] border-b border-[#D7D7D7] whitespace-nowrap overflow-hidden">
            What our team says!
          </h1>
          ...
          >
            {sld.map((slide, index) => (
              <SwiperSlide key={index}>
                <div className="flex overflow-visible lg:flex-row flex-col w-full gap-[20px] lg:gap-[40px] pt-[20px] lg:pt-[55px]">
                  <div className="relative z-10 bg-[url(/Career/SlideImgs/slidethbg.png)] bg-cover bg-no-repeat bg-center flex justify-center items-center md:px-[5%] md:py-[5%] lg:px-0 lg:py-[60px] shadow-[4px_4px_34px_rgba(0,0,0,0.15)] overflow-visible">
                    <img
                      className="sm:w-[80%] w-full h-full"
                      src={slide.image}
                      alt={slide.title}
