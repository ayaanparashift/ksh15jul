...
//     <div className="absolute z-[1000] fix12 top-5 lg:top-[100px] left-[max(5%,calc((100vw-1250px)/2))] lg:mb-[0px] mb-[36px] tablinehead overflow-hidden whitespace-nowrap">
//       <div
//         className="relative flex lg:flex-row flex-col items-start pb-2 gap-[10px] sm:gap-[0px] lg:pb-[20px] overflow-hidden whitespace-nowrap lg:items-center justify-between w-full"
//         // initial={{ opacity: 0 }}
//         // whileInView={{ opacity: 1 }}
//         // viewport={{ once: true, amount: 0.1 }}
//         // transition={{ duration: 2, ease: [0.7, 0, 0.4, 1] }}
...
//               onClick={() => hideopen(btntitle?.hid)}
//               key={btntitle.title + " " + String(index)}
//               className={`lg:px-[16px] lg:w-auto w-full py-[6px] lg:py-[10px] text-[14px] flex-1 flex items-center justify-center rounded-[10px] border-[#d7d7d7] border-opacity-30 text-white border ${
//                 ach && ach === btntitle.hid
//                   ? "bg-[#E30613] border-[#E30613]"
//                   : "bg-transparent"
//               }`}
