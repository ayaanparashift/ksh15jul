...
//         {/* Left Side Content */}
//         <motion.div
//           className="flex min-1920:mt-[190px] flex-col flex-1 max-w-full lg:gap-[30px] gap-2 xl:flex-[1] xl-1920:h-[500px] xl-1600:h-[500px] xl:h-[400px] md:h-[500px] md:justify-end h-full"
//           variants={fadeIn2}
//           initial="hidden"
//           animate={isActive ? "visible" : "hidden"}
//           exit="exit"
  ...
  return (
    <div className="bg-[url(/fistfold.png)] bg-cover bg-center min-w-screen">
      <div className="fix12 flex items-center lg:justify-center justify-end xl-1600:max-h-fit md:h-screen h-[90vh] pb-[75px] pt-[0px] md:py-[92px] xl:gap-[100px] md:gap-[50px] gap-[20px] md:flex-row flex-col-reverse">
        ...
        {/* Right Side Image */}
        <div className="md:min-h-screen min-h-fit h-fit flex-1 flex flex-col justify-end items-end">
          <div className="flex items-end justify-end flex-col min-1600:h-[695px] xl:w-[490.45px] xl:h-[595px] max-w-full">
            {/* Desktop Images */}
