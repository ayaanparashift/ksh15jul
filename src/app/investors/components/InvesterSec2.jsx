    ...
    <div className="fix12 py-[98px]">
      <div className="flex flex-col lg:flex-row justify-between gap-[20px] lg:gap-[5%]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          {/* Paragraphs */}
          <div className="text-[#434343] text-base leading-[26px] fsans-400 flex flex-col gap-3">
            <p>
              Large global investors have placed their confidence in KSH INFRA.
              We have built over 4 million square feet of Industrial & Logistics
              Infrastructure for major global companies like Kawasaki Motors,
              Jabil, Faurecia, Gedia, Rieter, Linamar, Saleri, and Kimberly
              Clark.
            </p>
            <p>
              Our success is driven by the trust and backing of prestigious
              global investment partners who share our commitment to excellence
              and sustainable growth. Every project undergoes rigorous
