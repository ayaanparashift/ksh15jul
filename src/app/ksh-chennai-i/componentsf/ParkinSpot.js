...
//               Located near Bengaluru, KSH Chennai Park I puts you right in India's
  ...
  return (
    <>
      <div className="bg-[#fff] bg-cover bg-center z-0 relative">
        <div className="ml-[max(5%,calc((100vw-1250px)/2))] lg:mr-0 mr-[max(5%,calc((100vw-1250px)/2))] pt-[150px] pb-12 flex items-center lg:justify-center justify-evenly min-1366:gap-[60px] md:gap-[50px] gap-[20px] lg:flex-row flex-col-reverse">
          {/* Left Side Content */}
          <div className="flex flex-col flex-1 max-w-full gap-5 min-1366:gap-10 justify-center relative">
            <div className="flex flex-col max-w-fit">
            ...
            <motion.p className="fsans-500 gradinetTextw text-[14px] lg:text-[14px] min-1366:text-[16px] leading-[26px]">
              Located near Chennai, KSH Chennai Park I puts you right in one of
              India's most strategic industrial corridors. The Sriperumbudur
              region is growing fast, making this the perfect location for
              companies ready to expand across South India. <br /> <br />
              We built these facilities with your needs in mind—sustainable,
              efficient, and adaptable. Move in and start operating immediately
              in spaces designed for safety and long-term success. Your business
              can hit the ground running from day one.
