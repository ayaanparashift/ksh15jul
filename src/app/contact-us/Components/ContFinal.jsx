...
const CONTACT_COMPANY_ID = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_CONTACT;
const CONTACT_AUTOREPLY_ID =
  process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_CONTACT_ALT;
const PUBLIC_KEY = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY;

const ContFinal = () => {
  const SUBJECT_EMAIL_MAP = {
    Careers: "ayaansayyed771@gmail.com",
    "General Enquiry": "ayaan.s@parashifttech.com",
    Support: "azamparashift@gmail.com",
    Partnership: "azamparashift@gmail.com",
    "Sales Enquiry": "azamparashift@gmail.com",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const receiverEmail =
      SUBJECT_EMAIL_MAP[formData.user_subject] || "ayaan.s@parashifttech.com";
    ...
    setIsSending(true);
    try {
      // 1️⃣ Send enquiry to mapped recipient (company template)
      await emailjs.send(SERVICE_ID, CONTACT_COMPANY_ID, {
        ...
        r_email: receiverEmail, // 👈 receiver instead of to_email
      });

      // 2️⃣ Send auto-reply back to the user
      await emailjs.send(SERVICE_ID, CONTACT_AUTOREPLY_ID, {
        to_name: formData.user_name,
        to_email: formData.user_email, // this stays for user
      });
        ...
        >
          ...
          <div className="relative w-full">
            <select
              ...
              disabled={isSending}
              className="w-full border-b border-b-[#146BD7] bg-[#263548] text-white outline-none fsans-400 text-[16px] px-[10px] py-[14px] appearance-none pr-10"
            >
